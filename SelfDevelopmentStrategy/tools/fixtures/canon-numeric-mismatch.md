<!-- FIXTURE (must fail): the hours here (2.0 / 6.5) contradict canon W01
     (3.0 / 5.5), while still summing to 15.0 so check-schema sees nothing
     wrong. Proves check-canon catches prose that quietly restates canon. -->
